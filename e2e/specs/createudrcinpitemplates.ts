var testdata = require('../inputs/testdata/createudrcinpitemplates.json');

import { browser, by, element } from 'protractor';

describe('widget', function () {
    it('pitemplates  create udrc charges ', function() {
        browser.sleep(5000);
      ...
      create.isPresent().then(function (result) {
          ...
          if (result) {
           ...
           browser.sleep(3000);
            ...
            browser.sleep(3000);
           element(by.xpath("//option[contains(text(),'Unit Dependent Recurring')]")).click();
            browser.sleep(3000);
           
            var unitrecurring = element(by.xpath("//ecb-create-pitemplate/ecb-modal-dialog/div/div/div/div/div[1]/dialog-body-template/div[2]/div/div/div/div/p/strong"));
            unitrecurring.isPresent().then(function (result) {
                 if (result) {
                ...
                console.log('popup is not came for create pi');
                    ...
                    console.log('table is not present to create unit dependent recurring charge'); 
                 }
             });
