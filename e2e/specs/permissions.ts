...
describe('widget', function () {
    ...
    it('permissionswidget', function() { 
     ...
     browser.actions().mouseMove(element(by.xpath("//h2[contains(text(),'Edit Subscription Settings')]"))).perform();
       ...
       element(by.xpath("//ecb-permissions/div/ngx-aside/aside/section/div/div/div[2]/form/div[1]/label/input")).click();
       browser.sleep(2000);
       element(by.xpath("//ecb-permissions/div/ngx-aside/aside/section/div/div/div[2]/form/div[2]/label/input")).click();
       element(by.xpath("//ecb-permissions/div/ngx-aside/aside/section/div/div/div[2]/form/div[2]/label/input")).click();
      
       element(by.xpath("//ecb-permissions/div/ngx-aside/aside/section/div/div/div[2]/form/div[1]/label/input")).click();
       element(by.xpath("//ecb-permissions/div/ngx-aside/aside/section/div/div/div[1]/div/div/button[2]")).click();
       browser.sleep(2000);  
        var modaldialogper = element(by.xpath("//ecb-permissions/div/div/ecb-modal-dialog/div/div/div/div[2]/div/button[1]"));
           modaldialogper.isPresent().then(function (result) {
           if(result){
       browser.actions().mouseMove(element(by.xpath("//ecb-permissions/div/div/ecb-modal-dialog/div/div/div/div[2]/div/button[1]"))).perform();
        browser.sleep(2000);
       element(by.xpath("//ecb-permissions/div/div/ecb-modal-dialog/div/div/div/div[2]/div/button[1]")).click();
       ...
       browser.sleep(2000);
         browser.actions().mouseMove(element(by.xpath("//ecb-permissions/div/div/ecb-modal-dialog/div/div/div/div[2]/div/button[1]"))).perform();
       element(by.xpath("//ecb-permissions/div/div/ecb-modal-dialog/div/div/div/div[2]/div/button[2]")).click(); // return
       browser.sleep(2000);
        browser.actions().mouseMove(element(by.xpath("//h2[contains(text(),'Edit Subscription Settings')]"))).perform();
      ...
      var accounttype = element(by.xpath("//ecb-permissions/div[1]/ngx-aside/aside/section/div/div/div[2]/form/div[5]/div/p-multiselect/div/div[3]/span")); 
         accounttype.isPresent().then(function (result) {
           if(result){
     browser.actions().mouseMove(element(by.xpath("//ecb-permissions/div[1]/ngx-aside/aside/section/div/div/div[2]/form/div[5]/div/p-multiselect/div/div[3]/span"))).perform();
     browser.sleep(2000);
     element(by.xpath("//ecb-permissions/div[1]/ngx-aside/aside/section/div/div/div[2]/form/div[5]/div/p-multiselect/div/div[3]/span")).click();
     browser.sleep(3000);
     element(by.xpath("//div[@class='ui-chkbox-box ui-widget ui-corner-all ui-state-default'][1]")).click();
     element(by.xpath("//div[@class='ui-chkbox-box ui-widget ui-corner-all ui-state-default'][2]"));
     browser.sleep(2000);
     element(by.xpath("//span[@class='fa fa-close']")).click();

     browser.sleep(3000);
           } else {
       console.log('account type dropdown is not there to select');
           }
         });
        ...
        // save
         element(by.xpath("//ecb-permissions/div/ngx-aside/aside/section/div/div/div[1]/div/div/button[1]")).click();
           ...
           if(result){
              ...
              element(by.xpath("//ecb-permissions/div/ngx-aside/aside/section/div/div/div[1]/div/div/button[2]")).click();
            var modaldialog1 = element(by.xpath("//ecb-permissions/div/div/ecb-modal-dialog/div/div/div/div[2]/div/button[1]"));
           modaldialog1.isPresent().then(function (result) {
           if(result){
       browser.actions().mouseMove(element(by.xpath("//ecb-permissions/div/div/ecb-modal-dialog/div/div/div/div[2]/div/button[1]"))).perform();
  
       element(by.xpath("//ecb-permissions/div/div/ecb-modal-dialog/div/div/div/div[2]/div/button[1]")).click(); // cancel
       browser.sleep(2000);
           } else {
