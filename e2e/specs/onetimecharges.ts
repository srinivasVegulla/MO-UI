...
describe('widget', function () {
  ...
  it('onetimecharges widget', function () {
     
       var priceableitems = element(by.xpath("//ecb-onetime-charges/div/div/div[@id='piCard']"));
    priceableitems.isPresent().then(function (result) {
          if (result) {
          element(by.xpath("//ecb-onetime-charges/div/div/div[@id='piCard']/div[1]/div[1]/div")).click();
            browser.sleep(5000);
