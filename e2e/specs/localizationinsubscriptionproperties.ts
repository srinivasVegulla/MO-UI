var testdata = require('../inputs/testdata/localization-subscriptionproperties.json');
...
describe('widget', function () {
  ...
  it('subscriptionproperties  page localization', function () {
     browser.sleep(5000);
    
 
    var localization = element(by.xpath("//ecb-contextbar/div/div/div/div/div/a"));
    localization.isPresent().then(function (result){
          ...
          var table = element(by.xpath("//ecb-localization/div[1]/ngx-aside/aside/section/div/div[2]/div[2]/p-datatable/div/div[1]/div/div[1]/div/table/thead/tr/th[1]/p-dropdown/div/label"));
      ...
      if (result) {
         ...
         console.log('placeholder is not there to enter values');
            ...
            browser.sleep(2000);
              ...
              console.log('table not loading in localization page in po details page');
            ...
            browser.sleep(3000);
              ...
              console.log('localization page is not came when clicking');
               ...
               console.log('localization link is not there in subscription properties page');
              }
    });
