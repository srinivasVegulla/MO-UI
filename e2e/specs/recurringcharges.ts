...
describe('widget', function () {
  ...
  it('recurringcharges widget', function () {
    
        var priceableitems = element(by.xpath("//ecb-recurring-charges/div/div/div[@id='piCard']"));
    priceableitems.isPresent().then(function (result) {
          if (result) {
          element(by.xpath("//ecb-recurring-charges/div/div/div[@id='piCard']/div[1]/div[1]/div")).click();
            browser.sleep(3000);
