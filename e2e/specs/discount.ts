...
describe('widget', function () {
  ...
  it('discount widget', function () {
    
   
  
    
    browser.sleep(1000);
    var heading = element(by.xpath("//ecb-rates/div[1]/div/div/div[1]/div[1]/div[1]/h2/span"));
   ...
   browser.sleep(3000);  
           ...
           console.log('it is not in child pi page ');
          }
     });
     
    
       var priceableitems = element(by.xpath("//ecb-discount-charges/div/div/div[1]"));
    priceableitems.isPresent().then(function (result) {
          if (result) {
          element(by.xpath("//ecb-discount-charges/div/div/div[1]/div")).click();
            browser.sleep(3000);
