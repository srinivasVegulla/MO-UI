var testdata = require('../inputs/testdata/createonetimechargesinpitemplates.json');

import { browser, by, element } from 'protractor';

describe('widget', function () {
    it('pitemplates  create onetimecharges ', function() {
        browser.sleep(2000);
      ...
      create.isPresent().then(function (result) {
          ...
          if (result) {
           ...
           element(by.xpath("//option[contains(text(),'One Time')]")).click();
            ...
            var onetimenotfound = element(by.xpath("//ecb-create-pitemplate/ecb-modal-dialog/div/div/div/div/div[1]/dialog-body-template/div[2]/div/div/div/div/p/strong"));
            onetimenotfound.isPresent().then(function (result) {
                 if (result) {
                ...
                console.log('popup is not came for create pi');
                    ...
                    console.log('table is not present to create one time charge'); 
                 }
             });
