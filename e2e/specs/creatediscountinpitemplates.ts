var testdata = require('../inputs/testdata/creatediscountinpitemplates.json');

import { browser, by, element } from 'protractor';

describe('widget', function () {
    it('pitemplates  create discount ', function() {
        browser.sleep(5000);
        ...
        create.isPresent().then(function (result) {
            ...
            if (result) {
             ...
             browser.sleep(3000);
              ...
              browser.sleep(3000);
             element(by.xpath("//option[contains(text(),'Discount')]")).click();
              browser.sleep(3000);
