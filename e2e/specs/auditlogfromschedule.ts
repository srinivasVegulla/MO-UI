var testdata = require('../inputs/testdata/auditlogfromschedule.json');

import { browser, by, element } from 'protractor';

describe('widget', function () {

 it('auditlog from rateschedule', function () {
      ...
      auditlog.isPresent().then(function (result) {
        ...
        if(result){
         ...
         browser.sleep(2000);
         // refreshing
         element(by.xpath("//em[@class='fa fa-refresh ecb-enableAlignIcon']")).click();
         browser.sleep(3000);
