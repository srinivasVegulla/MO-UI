var testdata = require('../inputs/testdata/RCchargedetailsinpitemplates.json');

import { browser, by, element } from 'protractor';

describe('widget', function () {
    it('pitemplates recurring charges detail page ', function() {
    ...
    var heading = element(by.xpath("//ecb-breadcrumb/div[3]/h1"));
            ...
            if (result) {
                 expect(element(by.xpath("//ecb-breadcrumb/div[3]/h1")).getText()).toEqual(testdata.recurringheading); 
                 browser.sleep(2000);
